...
public class StudentTester
{
   ...
   */
   public static boolean constructorTestEdge()
   {
      try
      {
         Student s = new Student("Amanda", "", 10, 8);
         return true;
      }
   ...
   */
   ...
   {
      Student s=new Student("","O'Neal",10,8);
   ...
   */
   ...
   {
      Student s=new Student("Amanda ","O'Neal",10,8);
      return s.getFullName().equals("Amanda  O'Neal");
   }
   ...
   */
   ...
   {
      Student s=new Student("Amanda","O'Neal",8,8);
      return s.getGrade()==8;
   }
   ...
   */
   ...
   {
      Student s= new Student("Amanda","O'Neal",10,10);
   ...
   */
   ...
   {
      Student s=new Student("Amanda","O'Neal",12,8);
      
      return s.getGrade()==12;
   }
   ...
   */
   public static boolean addCourseTestEdge()
   {
      Student s=createStudent();
      s.addCourse("",3);
      if (java.util.Arrays.toString(s.getCourses()).equals("[Free, Free, , Free, Free, Free, Free, Free]"))
      {
         return true;
      }
      return false;
   ...
   */
   ...
   {
      Student s= new Student("Daniel","Ryaboshapka",7,8);
      return s.toString().equals("7: Daniel Ryaboshapka [Free, Free, Free, Free, Free, Free, Free, Free]");
   }
