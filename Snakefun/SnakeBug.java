...
public class SnakeBug extends Bug
{
	...
	private ArrayList<Location> tailLength;
	...
	public SnakeBug()
	{
		...
		tailLength=new ArrayList<Location>();
	...
	public void act()
	{
		if ( !canMove() )
		{
			...
			javax.swing.JOptionPane.showMessageDialog(null, "Score: " + tailLength.size(), "GAME OVER!", 0);
			System.exit(0);
		}
		else
			move(); 
	...
	{
      Grid<Actor> gr=getGrid();
      Location r=tailLength.get(tailLength.size()-1);
		tailLength.remove(r);
      Actor rr=gr.get(r);
